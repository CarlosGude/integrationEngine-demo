 ...
 *         connection_resolver?: scalar|Param|null, // Service ID implementing ConnectionResolverInterface, for integrations whose base_url/authorization vary per call via the $connection argument to send()/sendMany(). Optional — integrations that never pass $connection do not need one. // Default: null
 *         middlewares?: list<scalar|Param|null>,
 *         request_middlewares?: list<scalar|Param|null>,
 ...
 *     twig?: TwigConfig,
 *     integration_engine?: IntegrationEngineConfig,
